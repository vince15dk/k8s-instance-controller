...
import (
	...
	nhncloudcomv1beta1 "github.com/vince15dk/k8s-operator-nhncloud/pkg/apis/nhncloud.com/v1beta1"
	versioned "github.com/vince15dk/k8s-operator-nhncloud/pkg/client/clientset/versioned"
	internalinterfaces "github.com/vince15dk/k8s-operator-nhncloud/pkg/client/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/vince15dk/k8s-operator-nhncloud/pkg/client/listers/nhncloud.com/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NhncloudV1beta1().Instances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NhncloudV1beta1().Instances(namespace).Watch(context.TODO(), options)
			},
		},
		&nhncloudcomv1beta1.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nhncloudcomv1beta1.Instance{}, f.defaultInformer)
}
