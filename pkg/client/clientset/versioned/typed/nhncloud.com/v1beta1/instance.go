...
import (
	...
	scheme "github.com/vince15dk/k8s-operator-nhncloud/pkg/client/clientset/versioned/scheme"
...
func newInstances(c *NhncloudV1beta1Client, namespace string) *instances {
	return &instances{
		client: c.RESTClient(),
		ns:     namespace,
	}
